document.addEventListener('DOMContentLoaded', () => {
    ...
    // Elementos do Painel de Resultados
    ...
    agroForm.addEventListener('submit', (e) => {
        ...
        // Variáveis de Análise Estatística Simetrizada
        let pontuacao = 0;
        let statusTexto = "";
        let statusClasse = "";
        ...
        // Lógica Avançada baseada no Contexto da Escola do Campo
        if (tipoManejo === "alto") {
            pontuacao = 98;
        ...
        // Atualização Fluida dos Resultados no Dashboard
        txtPorcentagem.textContent = `${pontuacao}%`;
        txtStatus.textContent = statusTexto;
        
        // Remove classes antigas e adiciona a cor correta
